...
int main (int argc, char **argv){
	...
	while (ros::ok()){
        ...
        if(count>=5){
            ...
            s_oz_ctrl_input = PD_controller(s_oz_e_f, s_oz_e_f_p, S_OZ_P_GAIN, S_OZ_D_GAIN)*S_TIME;
            ...
            s_pz_ctrl_input = PD_controller(s_pz_e_f, s_pz_e_f_p, S_PZ_P_GAIN, S_PZ_D_GAIN)*S_TIME;
